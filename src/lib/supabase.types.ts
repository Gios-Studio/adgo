...
export type Database = {
  ...
  public: {
    Tables: {
      ads: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "v_campaign_ads"
          ...
          },
          {
            ...
            columns: ["campaign_id"]
            isOneToOne: false
            referencedRelation: "v_org_campaigns"
            referencedColumns: ["campaign_id"]
          },
        ]
      }
      ...
      report_subscriptions: {
        Row: {
          ...
          created_at: string | null
          frequency: Database["public"]["Enums"]["report_freq"]
          id: string
          org_id: string
    ...
    Functions: {
      ...
      validate_recipients_emails: {
        Args: { arr: string[] }
        Returns: boolean
      }
    }
    Enums: {
      report_freq: "daily" | "weekly" | "monthly"
