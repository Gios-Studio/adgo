        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-8 text-gray-700">
            <section>
              ...
              <p className="mb-4">
                Welcome to AdGo Solutions Limited ("AdGo," "we," "us," or
                "our"). These Terms of Service ("Terms") govern your use of our
                mobile advertising platform and related services (the
                "Services").
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                and AdGo Solutions Limited. By creating an account, accessing
                our platform, or using our Services, you acknowledge that you
            ...
            <section>
              ...
              <p className="mb-4">
                AdGo provides a mobile advertising platform that connects
                advertisers with ride-sharing drivers and passengers in Kenya.
            ...
            <section>
              ...
              <p className="mb-4">
                AdGo retains all rights to our platform, software, trademarks,
                and proprietary content. You are granted a limited,
                non-exclusive license to use our Services for their intended
                purpose.
              </p>
              <p className="mb-4">
                You retain ownership of your advertising content but grant us a
                license to display, distribute, and analyze it as necessary to
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                uninterrupted access to our Services. We may:
              </p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p className="mb-4">
                To the fullest extent permitted by law, AdGo shall not be liable
              ...
              <p className="mb-4">
                ...
                to AdGo in the 12 months preceding the claim.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                You agree to indemnify and hold harmless AdGo and its officers,
                directors, employees, and agents from any claims, damages,
                losses, and expenses arising from your use of our Services,
            ...
            <section>
              ...
              <p className="mb-4">
                Either party may terminate these Terms at any time with or
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>
                  Provisions relating to liability and intellectual property
                  will survive
                </li>
              </ul>
            </section>
