          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <p className="text-xl text-muted-foreground mb-8 max-w-2xl">
                Stop wasting ad spend on broad audiences. AdGo uses AI-powered
                geo-targeting and behavioral insights to deliver your ads to the
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6">Why AdGo is Different</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Traditional advertising platforms waste your budget on unqualified
              leads. AdGo's AI-powered platform ensures every dollar spent
              reaches your ideal customer.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Get early access to the platform that's changing how businesses
              advertise. Plus, help us validate our pricing with your input.
            </p>
          </div>
          ...
          <Card className="max-w-2xl mx-auto shadow-xl border-0 bg-white/95 backdrop-blur">
            <CardHeader>
              ...
              <p className="text-center text-muted-foreground text-lg">
                Be among the first to experience hyper-targeted advertising that
                actually works
              </p>
            </CardHeader>
              ...
              <form onSubmit={handleWaitlistSignup}>
                  ...
                  >
                    <div className="grid grid-cols-2 gap-3">
                      {[
                        ...
                        <div
                          key={option.value}
                          className="flex items-center space-x-2 p-3 border rounded-lg hover:bg-primary/5 transition-colors"
                        >
                          <RadioGroupItem
                            value={option.value}
                            id={option.value}
                ...
                <div className="mb-6">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={setPrimaryChallenge}
                  >
                ...
                <div className="mb-6">
                  <label className="text-sm font-medium mb-3 block text-accent">
                    💰 Would you pay for a solution that increases ad ROI by
                    300%?
                  </label>
                  <RadioGroup
                    value={willingToPay}
                  ...
                  >
                    <div className="space-y-2">
                      {[
                        {
                          value: "yes",
                          label: "Yes, absolutely! Show me pricing",
                          color: "text-green-600",
                        },
                        {
                          value: "maybe",
                          label: "Maybe, depends on pricing and features",
                          color: "text-yellow-600",
                        },
                        {
                          value: "no",
                          label: "No, looking for free solutions only",
                          color: "text-red-600",
                        },
                      ].map((option) => (
                        <div
      ...
      <footer className="bg-white border-t py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-muted-foreground mb-4">
                The future of hyper-targeted advertising. Reach your ideal
                customers with AI-powered precision.
              </p>
          ...
          <div className="border-t mt-12 pt-8 text-center text-sm text-muted-foreground">
            <p>
              &copy; 2025 AdGo Solutions Limited. All rights reserved. Built
