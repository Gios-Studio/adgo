          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-green-500 pl-4">
                  <h3 className="text-lg font-medium text-gray-900 mb-2">2.1 Necessary Cookies</h3>
                ...
                <div className="border-l-4 border-blue-500 pl-4">
                  ...
                  <p className="mb-2">These cookies enhance your experience by remembering your choices and preferences.</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li><strong>Language Settings:</strong> Remember your preferred language</li>
                    <li><strong>Theme Preferences:</strong> Save dark/light mode settings</li>
                ...
                <div className="border-l-4 border-yellow-500 pl-4">
                  ...
                  <p className="mb-2">These cookies help us understand how visitors use our website so we can improve it.</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li><strong>Google Analytics:</strong> Track website usage and performance</li>
                    <li><strong>Hotjar:</strong> Understand user behavior through heatmaps</li>
                    <li><strong>Custom Analytics:</strong> Monitor platform-specific metrics</li>
                ...
                <div className="border-l-4 border-purple-500 pl-4">
                  ...
                  <p className="mb-2">These cookies are used to deliver relevant advertisements and track campaign performance.</p>
                  <ul className="list-disc pl-6 space-y-1">
                    <li><strong>Facebook Pixel:</strong> Track conversions from Facebook ads</li>
                    <li><strong>Google Ads:</strong> Measure advertising effectiveness</li>
                    <li><strong>Retargeting:</strong> Show relevant ads to returning visitors</li>
                    <li><strong>Campaign Attribution:</strong> Track which marketing efforts are most effective</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li><strong>Google Services:</strong> Analytics, Ads, Maps, and other Google products</li>
                <li><strong>Social Media:</strong> Facebook, Twitter, LinkedIn integration</li>
                <li><strong>Payment Processors:</strong> Stripe, PayPal, and mobile money providers</li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">4. How We Use Cookies</h2>
              <p className="mb-4">We use cookies for the following purposes:</p>
              
              <div className="space-y-4">
                <div>
                  <h3 className="font-medium text-gray-900">Platform Functionality</h3>
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Authenticate users and maintain secure sessions</li>
                    <li>Remember user preferences and settings</li>
                    <li>Provide personalized dashboard experiences</li>
                    <li>Enable shopping cart and payment functionality</li>
                  </ul>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Performance and Analytics</h3>
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>Optimize loading speeds and user experience</li>
                  </ul>
                </div>

                <div>
                  <h3 className="font-medium text-gray-900">Marketing and Advertising</h3>
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Deliver targeted advertising campaigns</li>
                    <li>Measure advertising effectiveness and ROI</li>
                    <li>Retarget visitors with relevant content</li>
                    <li>Track conversion events and attribution</li>
                  </ul>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">5.1 Consent Banner</h3>
              <p className="mb-4">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">5.2 Cookie Preference Center</h3>
              <p className="mb-4">
              ...
              <ul className="list-disc pl-6 space-y-1 mb-4">
                ...
                <li>Using the cookie banner if it appears</li>
              </ul>

              <h3 className="text-lg font-medium text-gray-900 mb-2">5.3 Browser Settings</h3>
              <p className="mb-4">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                  <h3 className="font-medium text-red-900 mb-2">Necessary Cookies</h3>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <h3 className="font-medium text-blue-900 mb-2">Functional Cookies</h3>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <h3 className="font-medium text-yellow-900 mb-2">Analytics Cookies</h3>
                ...
                <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                  <h3 className="font-medium text-purple-900 mb-2">Marketing Cookies</h3>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">7. Cookie Retention Periods</h2>
                ...
                <table className="min-w-full border border-gray-300">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 px-4 py-2">User preferences and analytics</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 px-4 py-2">Advertising Cookies</td>
                      <td className="border border-gray-300 px-4 py-2">90 days - 1 year</td>
                      <td className="border border-gray-300 px-4 py-2">Campaign tracking and retargeting</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">10. Related Policies</h2>
              <p className="mb-4">
                This Cookie Policy should be read alongside our other policies:
              </p>
              <ul className="space-y-2">
                <li><a href="/privacy-policy" className="text-blue-600 hover:underline">Privacy Policy</a> - How we collect and use your personal data</li>
                <li><a href="/terms-of-service" className="text-blue-600 hover:underline">Terms of Service</a> - Your rights and obligations when using our services</li>
              </ul>
            </section>
          </div>
        </div>
