...
const adUploadSchema = z.object({
  ...
  budget: z.number().min(100, 'Minimum budget is $100').max(50000, 'Maximum budget is $50,000'),
  campaignDuration: z.number().min(1, 'Minimum duration is 1 day').max(90, 'Maximum duration is 90 days'),
  languages: z.array(z.string()).min(1, 'Select at least one language'),
  radius: z.number().min(1, 'Minimum radius is 1km').max(100, 'Maximum radius is 100km'),
  ageRange: z.object({
  ...
  demographics: z.object({
    ...
    commuterType: z.array(z.enum(['daily', 'occasional', 'weekend', 'business']))
  }),
...
const INTERESTS = [
  ...
  'Gaming', 'Health & Fitness', 'Business', 'Education', 'Shopping',
  'Entertainment', 'News', 'Finance', 'Real Estate', 'Automotive'
]

const REGIONS = [
  { value: 'nairobi', label: 'Nairobi County', cities: ['Nairobi CBD', 'Westlands', 'Karen', 'Kilimani'] },
  { value: 'mombasa', label: 'Mombasa County', cities: ['Mombasa Island', 'Nyali', 'Bamburi', 'Likoni'] },
  { value: 'kisumu', label: 'Kisumu County', cities: ['Kisumu Central', 'Kondele', 'Mamboleo'] }
]
      ...
      <CardContent className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-gray-600 mt-2">
            {watchedValues.description || 'Your ad description will appear here...'}
          </p>
        </div>
        ...
        <div className="space-y-2 text-xs text-gray-500">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Radius: {watchedValues.radius}km around {watchedValues.city || 'selected city'}</span>
          </div>
          <div className="flex items-center gap-2">
            <Users className="h-3 w-3" />
            <span>Ages: {watchedValues.ageRange?.min}-{watchedValues.ageRange?.max}</span>
          </div>
          <div className="flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Create New Ad Campaign</h1>
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        <Slider
                          ...
                          onValueChange={(value) => setValue('campaignDuration', value[0])}
                          max={90}
                          min={1}
                          step={1}
                          className="w-full"
                        ...
                        <div className="flex justify-between text-sm text-gray-500 mt-1">
                          <span>1 day</span>
                          <span className="font-medium">{watchedValues.campaignDuration || 7} days</span>
                          <span>90 days</span>
                        </div>
                      </div>
                    </div>
                      ...
                      <label htmlFor="media-upload" className="cursor-pointer">
                        {mediaPreview ? (
                          <div className="space-y-2">
                            ...
                            <p className="text-green-600 font-medium">Media uploaded successfully</p>
                          ...
                          <div className="space-y-2">
                            ...
                            <div>
                              <p className="text-lg font-medium">Upload your ad media</p>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                          ...
                          <div key={lang.value} className="flex items-center space-x-2">
                            <Checkbox
                              ...
                              onCheckedChange={(checked) => {
                                if (checked) {
                                  const newLangs = [...selectedLanguages, lang.value]
                                  setSelectedLanguages(newLangs)
                                  setValue('languages', newLangs)
                                } else {
                                  const newLangs = selectedLanguages.filter(l => l !== lang.value)
                                  setSelectedLanguages(newLangs)
                                  setValue('languages', newLangs)
                                }
                              }}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <Label>City *</Label>
                        <Select onValueChange={(city) => setValue('city', city)}>
                          <SelectTrigger>
                    ...
                    <div>
                      ...
                      <div className="mt-2">
                        ...
                        <div className="flex justify-between text-sm text-gray-500 mt-1">
                          <span>1km</span>
                          <span className="font-medium">{watchedValues.radius || 25}km</span>
                          <span>100km</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mt-2">
                        <div>
                          ...
                          <Select onValueChange={(age) => setValue('ageRange.min', parseInt(age))}>
                            <SelectTrigger>
                        ...
                        <div>
                          ...
                          <Select onValueChange={(age) => setValue('ageRange.max', parseInt(age))}>
                            <SelectTrigger>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Alert>
                      <AlertDescription>
                        ...
                        • Daily spend: ${Math.round((watchedValues.budget || 0) / (watchedValues.campaignDuration || 1))}<br/>
                        • Estimated reach: {Math.round((watchedValues.budget || 0) * 2.5).toLocaleString()} people<br/>
