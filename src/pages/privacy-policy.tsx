        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-8 text-gray-700">
            ...
            <section>
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">1.3 Advertising Data</h3>
              <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <section>
              ...
              <p className="mb-4">Under the Kenya DPA and GDPR, you have the right to:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p className="mb-4">
                For detailed information, see our <a href="/cookie-policy" className="text-blue-600 hover:underline">Cookie Policy</a>.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="mt-6 space-y-2">
                <p><strong>Supervisory Authority (Kenya)</strong></p>
                <p>Office of the Data Protection Commissioner</p>
                <p>Website: <a href="https://www.odpc.go.ke" className="text-blue-600 hover:underline">www.odpc.go.ke</a></p>
              </div>
            </section>
          </div>
        </div>
