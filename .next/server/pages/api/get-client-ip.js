...
(() => {
  ...
  ((a.id = 5915),
    ...
    (a.modules = {
      173: (a, b, c) => {
        (c.r(b),
          c.d(b, { config: () => m, default: () => l, handler: () => o }));
        var d = {};
        (c.r(d), c.d(d, { default: () => i }));
        var e = c(9046),
          f = c(8667),
          g = c(3480),
          h = c(6435);
        function i(a, b) {
          let c = a.headers["x-forwarded-for"],
            d = a.headers["x-real-ip"],
            e = a.connection?.remoteAddress || a.socket?.remoteAddress,
            f = "unknown";
          ("string" == typeof c
            ? (f = c.split(",")[0].trim())
            : "string" == typeof d
              ...
              : e && (f = e),
            "::1" === f && (f = "127.0.0.1"),
            b.status(200).json({ ip: f }));
        }
        var j = c(8112),
          k = c(6385);
        let l = (0, h.M)(d, "default"),
          m = (0, h.M)(d, "config"),
          n = new g.PagesAPIRouteModule({
            definition: {
              kind: f.A.PAGES_API,
              page: "/api/get-client-ip",
              pathname: "/api/get-client-ip",
              bundlePath: "",
              filename: "",
            },
            userland: d,
        ...
        async function o(a, b, c) {
          let d = await n.prepare(a, b, { srcPage: "/api/get-client-ip" });
          if (!d) {
            ((b.statusCode = 400),
              b.end("Bad Request"),
          ...
          try {
            let c = a.method || "GET",
              ...
              l = n.instrumentationOnRequestError.bind(n),
              m = async (e) =>
                n
                  .render(a, b, {
                    query: { ...f, ...g },
                  ...
                  .finally(() => {
                    ...
                    if (!f) return;
                    if (
                      f.get("next.span_type") !== k.BaseServerSpan.handleRequest
                    )
