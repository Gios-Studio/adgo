            ...
            let a = E.method || "GET",
              ...
              x = async (f) => {
                ...
                if ((!al || (null == K ? void 0 : K.isMiss) || (al = !1), K)) {
                  if (
                    ...
                    if ("number" == typeof K.cacheControl.revalidate) {
                      ...
                      H = {
                        ...
                        expire:
                          (null == (x = K.cacheControl) ? void 0 : x.expire) ??
                          ac.expireTime,
                      };
                      ...
                      return (
                        await ((a) => {
                          ...
                          (d &&
                            ...
                            b.destination.startsWith("/") &&
                              (b.destination = (0, n.normalizeRepeatedSlashes)(
                                b.destination,
                              )),
                            (F.statusCode = c),
                  ...
                  if (
                    (z.isDev &&
                      F.setHeader("Cache-Control", "no-store, must-revalidate"),
                    X &&
                      F.setHeader(
                        "Cache-Control",
