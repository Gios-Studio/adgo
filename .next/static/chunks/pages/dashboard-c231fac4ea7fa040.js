(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9724],
  {
      ...
      function d(e) {
        ...
        return (0, a.jsxs)("div", {
          ...
          children: [
            ...
            (0, a.jsx)("main", { className: "p-8", children: s }),
          ],
        });
      }
    },
    ...
    39543: (e, s, r) => {
      "use strict";
      (r.r(s), r.d(s, { __N_SSG: () => L, default: () => U }));
      var a = r(37876),
        t = r(14232),
        i = r(44190),
        n = r(20564),
        ...
        L = !0;
      function U() {
        let [e, s] = (0, t.useState)(null),
          [r, L] = (0, t.useState)(null),
          [U, O] = (0, t.useState)(!0),
          [T, P] = (0, t.useState)(!1),
          K = async () => {
            try {
              ...
              let {
                data: { user: e },
              } = await i.N.auth.getUser();
              if (!e) throw Error("Not authenticated");
              let { data: r } = await i.N.from("profiles")
                .select("role")
                .eq("id", e.id)
                .single();
              L((null == r ? void 0 : r.role) || "advertiser");
              let a = {
                partner: {
                  campaigns: 45,
                  impressions: 125e3,
                ...
                charts: {
                  performanceData: Array.from({ length: 30 }, (e, s) => ({
                    date: (0, B.GP)(
                      new Date(Date.now() - (29 - s) * 864e5),
                      "MMM dd",
                    ),
                  ...
                  timeData: Array.from({ length: 24 }, (e, s) => ({
                    hour: "".concat(s, ":00"),
              ...
              (console.error("Error fetching dashboard data:", e),
                F.oR.error("Failed to load dashboard data"));
            } finally {
              (O(!1), P(!1));
            }
          };
        (0, t.useEffect)(() => {
          K();
          let e = setInterval(K, 1e4);
          return () => clearInterval(e);
        }, []);
        let V = async () => {
          (0, F.oR)("PDF export feature coming soon", { icon: "\uD83D\uDCC4" });
        };
        return U
          ? (0, a.jsx)(n.A, {
              children: (0, a.jsx)("div", {
                ...
                children: (0, a.jsxs)("div", {
                  ...
                  children: [
                    ...
                    (0, a.jsx)("p", { children: "Loading dashboard..." }),
                  ],
                }),
              }),
            })
                          ...
                          children: [
                            (0, a.jsxs)("h1", {
                              ...
                              children: [
                                ...
                                "advertiser" === r && "Advertiser Dashboard",
                                "driver" === r && "Driver Dashboard",
                              ],
                            }),
                            (0, a.jsx)("p", {
                        ...
                        (0, a.jsxs)("div", {
                          ...
                          children: [
                            ...
                            (0, a.jsxs)(c.$, {
                              onClick: () => {
                                if (!e) return;
                                let s = e.charts.performanceData
                                    .map((e) =>
                                      ""
                                        .concat(e.date, ",")
                                        .concat(e.impressions, ",")
                                        .concat(e.clicks, ",")
                                        .concat(e.revenue, ",")
                                        .concat(e.spend),
                                    )
                                  ...
                                  r = new Blob(
                                    [
                                      "Date,Impressions,Clicks,Revenue,Spend\n".concat(
                                        s,
                                      ),
                                    ],
                                    { type: "text/csv" },
                                ...
                                ((t.href = a),
                                  (t.download = "adgo-analytics-".concat(
                                    (0, B.GP)(new Date(), "yyyy-MM-dd"),
                                    ".csv",
                                  )),
                                  ...
                                  F.oR.success("CSV exported successfully"));
                              },
                              variant: "outline",
                              children: [
                                (0, a.jsx)(_.A, { className: "h-4 w-4 mr-2" }),
                                "CSV",
                              ],
                            }),
                            (0, a.jsxs)(c.$, {
                                                ...
                                                (0, a.jsxs)("div", {
                                                  children: [
                                                    ...
                                                    (0, a.jsxs)("p", {
                                                      ...
                                                      children: [
                                                        "$",
                                                        e.partner.revenue.toLocaleString(),
                                                      ],
                                                    }),
                                                  ],
                                                }),
                                        ...
                                        children: [
                                          ...
                                          (0, a.jsx)(l.Wu, {
                                            children: (0, a.jsx)(x.u, {
                                              width: "100%",
                                              height: 300,
                                              children: (0, a.jsxs)(m.Q, {
                                                data: e.charts.performanceData,
                                                children: [
                                                  (0, a.jsx)(h.d, {
                                                    strokeDasharray: "3 3",
                                                  }),
                                              ...
                                              (0, a.jsxs)("div", {
                                                children: [
                                                  ...
                                                  (0, a.jsxs)("p", {
                                                    ...
                                                    children: [
                                                      "$",
                                                      e.advertiser.adSpend.toLocaleString(),
                                                    ],
                                                  }),
                                                ],
                                              }),
                                                ...
                                                children: [
                                                  ...
                                                  (0, a.jsx)("p", {
                                                    className:
                                                      "text-2xl font-bold",
                                                    children:
                                                      e.advertiser.impressions.toLocaleString(),
                                                  }),
                                                ],
                                              }),
                                              (0, a.jsx)(E.A, {
                                                ...
                                                children: [
                                                  ...
                                                  (0, a.jsx)("p", {
                                                    className:
                                                      "text-2xl font-bold",
                                                    children:
                                                      e.advertiser.clicks.toLocaleString(),
                                                  }),
                                                ],
                                              }),
                                              (0, a.jsx)(I.A, {
                                              ...
                                              (0, a.jsxs)("div", {
                                                children: [
                                                  ...
                                                  (0, a.jsxs)("p", {
                                                    ...
                                                    children: [
                                                      "KES ",
                                                      e.driver.earnings.toLocaleString(),
                                                    ],
                                                  }),
                                                ],
                                              }),
                                              ...
                                              (0, a.jsxs)("div", {
                                                children: [
                                                  ...
                                                  (0, a.jsxs)("p", {
                                                    ...
                                                    children: [
                                                      "KES ",
                                                      e.driver.walletBalance.toLocaleString(),
                                                    ],
                                                  }),
                                                ],
                                              }),
                                              ...
                                              (0, a.jsxs)("div", {
                                                children: [
                                                  (0, a.jsx)("p", {
                                                    className:
                                                      "text-sm font-medium text-gray-500",
                                                    children: "Ad Views Today",
                                                  }),
                                                  (0, a.jsx)("p", {
                                                    className:
                                                      "text-2xl font-bold",
                                                    children: e.driver.adViews,
                                                  }),
                                                ],
                                              }),
                                              (0, a.jsx)(E.A, {
    ...
    42298: (e, s, r) => {
      ...
      let d = (0, n.F)(
        ...
        c = t.forwardRef((e, s) => {
          let { className: r, variant: t, size: n, asChild: c = !1, ...o } = e,
            x = c ? i.DX : "button";
          return (0, a.jsx)(x, {
            className: (0, l.cn)(d({ variant: t, size: n, className: r })),
            ref: s,
            ...o,
          });
        });
    ...
    76423: (e, s, r) => {
      ...
      function l(e) {
        let { className: s, variant: r, ...t } = e;
        return (0, a.jsx)("div", {
          className: (0, i.cn)(n({ variant: r }), s),
          ...t,
        });
      }
    },
  ...
  (e) => {
    (e.O(0, [1987, 9008, 9853, 6582, 2880, 3172, 636, 6593, 8792], () =>
      e((e.s = 67580)),
    ),
      (_N_E = e.O()));
  },
