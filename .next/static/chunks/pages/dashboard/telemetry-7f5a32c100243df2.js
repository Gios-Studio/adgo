(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [3428],
  {
    ...
    21813: (e, s, t) => {
      "use strict";
      (t.r(s), t.d(s, { __N_SSG: () => S, default: () => I }));
      var r = t(37876),
        a = t(14232),
        l = t(61629),
        n = t(31188),
      ...
      function I() {
        ...
        (0, a.useEffect)(() => {
          q();
          let e = setInterval(q, 3e4);
          return () => clearInterval(e);
        }, [U, K]);
        let q = async () => {
            try {
              O(!0);
              let { data: e, error: s } = await G.from("license_usage_summary")
                .select("*")
                .order("usage_percentage", { ascending: !1 });
              if (s) throw s;
              let { data: t, error: r } = await G.rpc("get_license_analytics", {
                days_back: parseInt(U),
              });
              if (r) throw r;
              let a = G.from("telemetry_events")
                .select(
              ...
              if (n) throw n;
              let { data: i } = await G.from("telemetry_events")
                          ...
                          children: [
                            ...
                            (0, r.jsxs)("p", {
                              ...
                              children: [
                                ...
                                (null == F ||
                                null == (B = F.analytics) ||
                                null == (I = B.avg_usage_per_license)
                                  ? void 0
                                  : I.toFixed(1)) || 0,
                                " per license",
                              ],
