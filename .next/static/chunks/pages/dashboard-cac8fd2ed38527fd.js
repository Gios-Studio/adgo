  ...
  [9724],
  {
    ...
    39543: (e, s, r) => {
      ...
      function _() {
          ...
          K = async () => {
            try {
              ...
              let { data: r } = await i.N.from("profiles")
                ...
                .eq("id", e.id)
                .single();
              _((null == r ? void 0 : r.role) || "advertiser");
              let a = {
                partner: {
                  campaigns: 45,
                  impressions: 125e3,
              ...
              (console.error("Error fetching dashboard data:", e),
                L.oR.error("Failed to load dashboard data"));
            } finally {
              (O(!1), P(!1));
            }
          };
        ...
        let V = async () => {
          (0, L.oR)("PDF export feature coming soon", { icon: "\uD83D\uDCC4" });
        };
        return U
          ? (0, a.jsx)(n.A, {
              children: (0, a.jsx)("div", {
                            ...
                            (0, a.jsxs)(c.$, {
                              onClick: () => {
                                ...
                                ((t.href = a),
                                  ...
                                  L.oR.success("CSV exported successfully"));
                              },
                              variant: "outline",
                              children: [
