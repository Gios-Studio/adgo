(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9743],
  {
      ...
      function c(e) {
        ...
        return (0, r.jsxs)("div", {
          ...
          children: [
            ...
            (0, r.jsx)("main", { className: "p-8", children: t }),
          ],
        });
      }
    },
    ...
    83746: (e, t, a) => {
      ...
      function c() {
          ...
          return (
            (async () => {
              ...
              try {
                if (!n.N)
                  return void c(
                    "Supabase client not initialized. Check your env vars.",
                  );
                let { data: e, error: t } = await n.N.auth.getSession();
                if (t) throw t;
                let r = null == (a = e.session) ? void 0 : a.user.id;
                if (!r) return void c("Not signed in.");
                let { data: s, error: l } = await n.N.from("wallets")
                ...
                o(s);
                let { data: i, error: d } = await n.N.from("transactions")
                ...
                (console.error("Wallet fetch error →", e),
                  c(null != (r = e.message) ? r : "Failed to load wallet."));
              } finally {
                e && t(!1);
              }
            })(),
        ...
        e)
          ? (0, r.jsx)(l.A, {
              children: (0, r.jsx)("div", { children: "Loading wallet…" }),
            })
          : a
            ? (0, r.jsx)(l.A, {
                      ...
                      (0, r.jsxs)("header", {
                        ...
                        children: [
                          (0, r.jsxs)("h1", {
                            ...
                            children: ["Wallet (", d.currency, ")"],
                          }),
                          (0, r.jsx)("div", {
                            className: "text-2xl",
                            children: i(d.balance_cents),
                          }),
                        ],
                      }),
                      (0, r.jsxs)("section", {
              ...
              : (0, r.jsx)(l.A, {
                  children: (0, r.jsxs)("div", {
                    ...
                    children: [
                      ...
                      (0, r.jsx)("p", { children: "No KES wallet found yet." }),
                      (0, r.jsx)("p", {
                        className: "text-sm text-neutral-600",
                        children:
  ...
  (e) => {
    (e.O(0, [9008, 636, 6593, 8792], () => e((e.s = 67714))), (_N_E = e.O()));
  },
]);
