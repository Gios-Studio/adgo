(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [8932],
  {
    12685: (e, r, a) => {
      ...
      var l = a(37876),
        ...
        d = a(97685);
      function i() {
        let [e, r] = (0, s.useState)("Food & Drink"),
          [a, i] = (0, s.useState)("7 days"),
          [c, u] = (0, s.useState)(null),
          h = async () => {
            if (!c) return void d.Ay.error("Please select a file first.");
            let { data: e, error: r } = await o.N.storage
              .from("ads")
              .upload("uploads/".concat(c.name), c);
            if (r) return void d.Ay.error("Upload failed.");
                ...
                children: [
                  (0, l.jsx)("input", {
                    ...
                    onChange: (e) => {
                      ...
                      return u(
                        null !=
                          (a = null == (r = e.target.files) ? void 0 : r[0])
                          ? a
                          : null,
                      );
                    },
      ...
      function d(e) {
        ...
        return (0, l.jsxs)("div", {
          ...
          children: [
            ...
            (0, l.jsx)("main", { className: "p-8", children: r }),
          ],
        });
      }
    },
  ...
  (e) => {
    (e.O(0, [9008, 636, 6593, 8792], () => e((e.s = 21148))), (_N_E = e.O()));
  },
]);
