            ...
            (s =
              ...
              (l =
                ...
                (u =
                  ...
                  : d.weekStartsOn)
                ? l
                : null == (i = d.locale) || null == (a = i.options)
                  ? void 0
                  : a.weekStartsOn)
              ? s
              : 0,
            ...
            let r = (function (t) {
              ...
              return (
                (function (t, e) {
                  let n = h(t),
                    r = h(e);
                  return Math.round((n - m(n) - (r - m(r))) / 864e5);
                })(
                  e,
                  (function (t) {
                    let e = c(t),
      ...
      let x = (t, e) => {
        ...
        D = {
          ...
          P: (t, e) => {
            ...
            return n.replace("{{date}}", x(a, e)).replace("{{time}}", T(i, e));
          },
        },
        W = /^D+$/,
        O = /^Y+$/,
        ...
        A = /[a-zA-Z]/;
      function H(t, e, n) {
        var r, a, i, o, u, l, h, m, f, g, w, b, y, p, v, M, P, N;
        let S =
            null !=
            (g = null != (f = null == n ? void 0 : n.locale) ? f : d.locale)
              ? g
              : s,
          x =
            null !=
            ...
            (N =
              ...
              (P =
                ...
                (M =
                  ...
                  : d.weekStartsOn)
                ? P
                : null == (m = d.locale) || null == (h = m.options)
                  ? void 0
                  : h.weekStartsOn)
              ? N
              : 0,
        ...
        if (
          !(
            (H instanceof Date ||
              ("object" == typeof H &&
                "[object Date]" === Object.prototype.toString.call(H)) ||
              "number" == typeof H) &&
            !isNaN(Number(c(H)))
          )
        )
        ...
        let j = e
          ...
          .map((t) => {
            let e = t[0];
            return "p" === e || "P" === e ? (0, D[e])(t, S.formatLong) : t;
          })
          .join("")
          .match(E)
          .map((t) => {
            ...
            if (k[e]) return { isToken: !0, value: t };
            if (e.match(A))
              throw RangeError(
        ...
        S.localize.preprocessor && (j = S.localize.preprocessor(H, j));
        let L = { firstWeekContainsDate: x, weekStartsOn: T, locale: S };
        return j
          .map((r) => {
            ...
            return (
              ((!(null == n ? void 0 : n.useAdditionalWeekYearTokens) &&
                ...
                (function (t, e, n) {
                  ...
                  if ((console.warn(r), C.includes(t))) throw RangeError(r);
                })(a, e, String(t)),
              (0, k[a[0]])(H, a, S.localize, L)
            );
          })
          .join("");
      }
            ...
            o = (function (t) {
              ...
              let [a, o] = r.useState(),
                ...
                [c, h] =
                  ...
                  r.useReducer((t, e) => n[t][e] ?? t, e));
              return (
                r.useEffect(() => {
                  let t = u(l.current);
                  d.current = "mounted" === c ? t : "none";
                }, [c]),
                (0, i.N)(() => {
                  let e = l.current,
                    n = s.current;
                ...
                (0, i.N)(() => {
                  if (a) {
                    let t,
                      e = a.ownerDocument.defaultView ?? window,
                      n = (n) => {
                      ...
                      r = (t) => {
                        t.target === a && (d.current = u(l.current));
                      };
                    return (
                ...
                }, [a, h]),
                {
                  ...
                  ref: r.useCallback((t) => {
                    ((l.current = t ? getComputedStyle(t) : null), o(t));
                  }, []),
                }
              );
            })(e),
