  ...
  [5543],
  {
      ...
      let o = () =>
          (0, t.jsx)("div", {
            ...
            children: (0, t.jsx)("div", {
              className:
                "h-8 w-8 rounded-md bg-primary flex items-center justify-center",
              children: (0, t.jsx)("div", {
        ...
        n = () =>
          (0, t.jsx)("footer", {
            className:
              "w-full py-16 px-6 md:px-12 border-t border-border bg-card",
            children: (0, t.jsxs)("div", {
              ...
              children: [
                        ...
                        (0, t.jsxs)("div", {
                          ...
                          children: [
                            (0, t.jsx)("a", {
                              href: "#",
                              className:
                                "h-10 w-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:text-foreground transition-colors",
                ...
                (0, t.jsxs)("div", {
                  className:
                    "border-t border-border pt-8 mt-12 flex flex-col md:flex-row items-center justify-between gap-4",
                  children: [
                    (0, t.jsx)("p", {
                      className: "text-sm text-muted-foreground",
                      children:
                        "\xa9 2025 AdGo Solutions Limited. All rights reserved.",
                    }),
                    (0, t.jsxs)("div", {
                      className:
    ...
    42298: (e, r, s) => {
      ...
      let l = (0, i.F)(
        ...
        d = o.forwardRef((e, r) => {
          let { className: s, variant: o, size: i, asChild: d = !1, ...c } = e,
            h = d ? n.DX : "button";
          return (0, t.jsx)(h, {
            className: (0, a.cn)(l({ variant: o, size: i, className: s })),
            ref: r,
            ...c,
          });
        });
